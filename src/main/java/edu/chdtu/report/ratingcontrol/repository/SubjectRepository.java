...
public interface SubjectRepository extends CrudRepository<Subject, Integer>{
    @Query("select su from Subject su join su.groups gr where su.semester=:semester and gr.id=:groupId and "+
            "(su.knowledgeControl.id="+EXAM+" or su.knowledgeControl.id="+CREDIT+" or su.knowledgeControl.id="+DIFF_CREDIT+") "+
            "order by su.name")
